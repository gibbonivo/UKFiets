UKGame = function (configuration, loadingManager, logManager) {
	ENGINE2D.Simulator.call(this, loadingManager, logManager);
	this.configuration = configuration;
};

UKGame.prototype = Object.create(ENGINE2D.Simulator.prototype);

UKGame.prototype.BeforeSetUp = function () {
	/*STUB START*/
	this.game.AddLoader('image',new ENGINE2D.ImageLoader(this.loadingManager,this.logManager));
	
	/*STUB END*/
	this.logManager.Success('[UKGame.BeforeSetUp]');
};

UKGame.prototype.OnSetUp = function () {	
	/*STUB START*/
	var keyMap = {};
	...
	/*imageLoader.Load()*/
	/*STUB END*/
	this.logManager.Success('[UKGame.OnSetUp]');
};

UKGame.prototype.OnShutDown = function () {
	/*INTERFACE*/
	this.logManager.Success('[UKGame.OnShutDown]');
};

UKGame.prototype.OnInterpolate = function (alpha) {
	/*INTERFACE*/
	/*this.logManager.Debug('[UKGame.OnInterpolate]');*/
};

UKGame.prototype.OnSimulate = function (t, dt) {
	/*STUB START*/
...
UKGame.prototype.EvaluateInput = function () {
	/*INTERFACE*/
	/*this.logManager.Debug('[UKGame.EvaluateInput]');*/
};

UKGame.prototype.EvaluateGameLogics = function () {
	/*INTERFACE*/
	/*this.logManager.Debug('[UKGame.EvaluateGameLogics]');*/
};

UKGame.prototype.UpdateGameWorld = function () {
	/*INTERFACE*/	
	/*this.logManager.Debug('[UKGame.UpdateGameWorld]');*/
};

UKGame.prototype.UpdateCameras = function () {
	/*INTERFACE*/
	/*this.logManager.Debug('[UKGame.UpdateCameras]');*/
};

UKGame.prototype.UpdateGameState = function () {
	/*INTERFACE*/
	/*this.logManager.Debug('[UKGame.UpdateGameState]');*/
};